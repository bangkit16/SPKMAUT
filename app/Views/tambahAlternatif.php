...
<head>
    ...
    <title>Tambah Allternatif</title>
    <style>
        * {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                <div class="col-md-9 ">
                    <h1 class="h1 mb-5">Tambah Alternatif</h1>
                    <form method="post" action="addAlt">
                        <div class="mb-3">
                            <label for="alter" class="form-label">Nama Alternatif</label>
                            <input type="text" class="form-control" name="alt" id="alter" aria-describedby="emailHelp">
                        </div>
                        <h5 class="h5">Masukan Nilai Kriteria</h5>
                        <?php foreach ($krit as $k) : ?>
                            <div class="mb-3">
                                <label for="krite" class="form-label"><?= $k['krit']; ?></label>
                                <input type="number" class="form-control" name="nilai[]" id="krite" aria-describedby="emailHelp">
                            </div>
                        <?php endforeach; ?>
                        <!-- <div class="mb-3">
