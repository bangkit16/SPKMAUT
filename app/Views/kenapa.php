    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                ...
                <h1 class="h1 mb-3">Mengapa menggunakan Metode MAUT</h1>
                <div class="card col-md-7 mt-5">
                    <div class="card-body" style="font-weight: 400;font-size: x-large;">
                        Kelebihan <br>
                        Metode MAUT memiliki beberapa kelebihan, antara lain:
                        <ul>
                            <li>Dapat menangani kriteria yang bersifat kualitatif maupun kuantitatif.</li>
                            <li>Dapat menangani kriteria yang memiliki satuan yang berbeda.</li>
                            <li>Dapat menangani kriteria yang memiliki arah yang berbeda, yaitu benefit (semakin besar semakin baik) atau cost (semakin kecil semakin baik).</li>
                            <li>Dapat menangani ketidakpastian dan resiko dalam pengambilan keputusan.</li>
                            <li>Dapat menyesuaikan dengan preferensi dan nilai-nilai subjektif dari pengambil keputusan.</li>
                        </ul>
                        Contoh
                        <ul>
                            <li>Pemilihan saat membeli suatu barang dengan perbandingan berbagai aspek misalnya harga, warna, dan atribut lainnya. </li>
                        </ul>
                    </div>
                </div>
            </main>
