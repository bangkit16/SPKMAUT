    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2 bg-secondary rounded">
                            <a style="font-weight: 500; font-size: large;" class="nav-link text-white" href="perangkingan"><i class="bi bi-person-fill-up"></i> Perangkingan</a>
                        </li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                <h1 class="h1 mb-3">Perangkingan</h1>
