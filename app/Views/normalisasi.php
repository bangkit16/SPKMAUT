...
<head>
    ...
    <title>Normalisasi Matrix</title>
    <style>
        * {
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2 bg-secondary rounded">
                            <a style="font-weight: 500; font-size: large;" class="nav-link text-white" href="normalisasi"><i class="bi bi-archive"></i> Normalisasi</a>
                        </li>
                        <li class="nav-item mb-2 ">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                <h1 class="h1 mb-3">Normalisasi Matrix</h1>
                <table class="table mt-4 ">
                    <thead>
                        <tr>
                            <th scope="col" class="border" rowspan="2" style="vertical-align: middle;">No</th>
                            <th scope="col" class="border" rowspan="2" style="vertical-align: middle;">Alternatif</th>
