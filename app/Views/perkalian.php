    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2 ">
                            <a style="font-weight: 500; font-size: large;" class="nav-link text-black" href="/"><i class="bi bi-bar-chart-line"></i> Data Evaluasi</a>
                        </li>
                        <li class="nav-item mb-2 ">
                        ...
                        <li class="nav-item mb-2 bg-secondary rounded">
                            <a style="font-weight: 500; font-size: large;" class="nav-link text-white" href="perkalian"><i class="bi bi-clipboard2-x"></i> Perkalian Bobot</a>
                        </li>
                        <li class="nav-item mb-2 ">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                <h1 class="h1 mb-3">Perkalian Bobot</h1>
                <table class="table mt-4 ">
                    <thead>
                        <tr>
                            <th scope="col" class="border" rowspan="3" style="vertical-align: middle;">No</th>
                            <th scope="col" class="border" rowspan="3" style="vertical-align: middle;">Alternatif</th>
                            <th scope="col" class="border" colspan="<?= count($krit); ?>" style="text-align: center;">Kriteria</th>
                            <th scope="col" class="border" rowspan="3" style="vertical-align: middle;">Total</th>
                        </tr>
                        <tr>
