    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                <div class="col-md-9 ">
                    <h1 class="h1 mb-5">Edit Kriteria</h1>
                    <form method="post" action="updateKrit">
                        <div class="mb-3">
                            <label for="alter" class="form-label">Nama Kriteria</label>
                            <input type="text" class="form-control" value="<?= $krit; ?>" name="krit" id="alter" aria-describedby="emailHelp">
                            <input type="hidden" value="<?= $id; ?>" name="id">
                        </div>
                        <div class="mb-3">
                            <label for="bobot" class="form-label">Bobot Kriteria</label>
                            <input type="number" step="0.01" class="form-control" value="<?= $bobot; ?>" name="bobot" id="alter" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="bobot" class="form-label">Jenis Kriteria</label>
                            <input type="text" step="0.01" class="form-control" value="<?= $jenis; ?>" name="jenis" id="alter" aria-describedby="emailHelp">
                        </div>
                        <h5 class="h5">Masukan Nilai Alternatif</h5>
                        <?php foreach ($nilai as $k) : ?>
                            <div class="mb-3">
                                <label for="krite" class="form-label"><?= $k['alt']; ?></label>
                                <input type="number" class="form-control" value="<?= $k['nilai']; ?>" name="nilai[]" id="krite" aria-describedby="emailHelp">
                                <input type="hidden" value="<?= $k['id_alt']; ?>" name="id_alt[]">
                            </div>
                        <?php endforeach; ?>
                        <!-- <div class="mb-3">
