    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-5">
                ...
                <h1 class="h1 mb-3">Apa itu Metode MAUT</h1>
                <div class="card col-md-7 mt-5">
                    <div class="card-body" style="font-weight: 400;font-size: x-large;">
                        Metode MAUT (Multi Attribute Utility Theory) adalah salah satu metode yang digunakan dalam sistem pendukung keputusan (SPK) untuk mengevaluasi berbagai alternatif berdasarkan beberapa kriteria yang relevan. Metode ini mengubah nilai kriteria menjadi nilai utilitas, yang merupakan ukuran kepuasan atau preferensi terhadap suatu alternatif
                    </div>
                </div>
            </main>
        </div>
